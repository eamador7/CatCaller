...
#
#  - JAVA_HOME: path to a Java installation.
#  - GRADLE_HOME: path to a Gradle installation.
#  - GRADLE_OPTS: command-line options to pass to Gradle.
#  - JAVA_OPTS: command-line options to pass to the Java runtime.
#
...
# Set the default Gradle options.
# NOTE: "-Dorg.gradle.appname=$APP_BASE_NAME" is always applied
DEFAULT_GRADLE_OPTS="-Dorg.gradle.appname=$APP_BASE_NAME"
